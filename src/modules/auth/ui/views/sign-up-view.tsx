...
const formSchema = z.object({
    ...
    password: z.string().min(1, {message : "Pssword Is required"}),
    confirmPassword: z.string().min(1, {message : "Pssword Is required"})
    ...
    return(
        <div className="flex flex-col gap-6">
            ...
            <div className="bg-radial from-green-500 to-green-800 relative hidden md:flex flex-col gap-y-4 items-center justify-center">
                <img src ="/logo.svg" alt="Imeage" className="h-[92px] w-[92px]"/>
               <p className="text-2xl font-semibold text-white ">MeetPilot</p>
            </div>
            </CardContent>
        </Card>
